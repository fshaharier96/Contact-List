        ...
        <div class="create-lower-container">
            ...
            <div class="form-group d-flex flex-column mb-3">
                <div class="d-flex">
                    ...
                    <input class="form-control border border-secondary ms-1" type="text" name="fname"
            ...
            <div class="form-group d-flex flex-column mb-3">
                <input class="form-control border border-secondary ms-3 create-input-width" type="text" name="lname"
            ...
            <div class="form-group d-flex mb-3">
                <input class="form-control border border-secondary create-input-width ms-3" type="text" name="job_title"
            ...
            <div class="form-group d-flex mb-3">
                <input class="form-control border border-secondary ms-3" type="text" name="department"
            ...
            <div class="form-group d-flex mb-3">
                <input class="form-control border border-secondary ms-3" type="text" name="postal_code"
            ...
            <div class="form-group d-flex mb-3">
                ...
                <input id="datepicker" class="form-control border border-secondary ms-1" type="date" class="icon-input"
                       name="birth_date" placeholder="Birthday"/>
            </div>
            <!--            <div class="mb-3">-->
